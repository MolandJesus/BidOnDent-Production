...
**Companion docs:** [`MOLANDJESUS_DESIGN_DECISIONS.md`](MOLANDJESUS_DESIGN_DECISIONS.md) §9 inheritance rule, [`PLAN_LANDING_REDESIGN.md`](archive/PLAN_LANDING_REDESIGN_archived_2026-05-03.md) STATUS COMPLETE (the source quality bar this plan inherits without violating boundaries — archived 2026-05-03 after 16-pass completion), [`LAW_PROJECT_RULES.md`](LAW_PROJECT_RULES.md), [`bd-design-identity` skill](~/.claude/skills/bd-design-identity/SKILL.md), [`REF_SYSTEM_STATE.md`](REF_SYSTEM_STATE.md) for component map.
...
- ⛔ NO Direction C luminance accents per section (Pass 6 landing-only)
