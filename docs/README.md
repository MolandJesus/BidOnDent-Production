...
| [`PLAN_DOC_CONSOLIDATION_2026-05-04.md`](archive/PLAN_DOC_CONSOLIDATION_2026-05-04_archived_2026-05-05.md)                                          | **NEW (2026-05-04).** Phase 1.5 doc consolidation plan + audit table. Describes the 5-commit consolidation that produced this clean tree.                                                                                                                                                                                                                                                                                       |
...
| [`PLAN_MAP_UNIFICATION_2026-05-08.md`](PLAN_MAP_UNIFICATION_2026-05-08.md)                                                                          | **NEW (2026-05-08, audit AI Pass 10).** `<MapProgramShell>` slot-contract proposal that retires KI-170 / KI-171 / KI-172 by unifying the 5 divergent map surfaces. 9-pass migration roadmap; gated on master-builder review against `LAW_LAYERED_ARCHITECTURE.md` before any implementation pass starts.                                                                                                                        |
