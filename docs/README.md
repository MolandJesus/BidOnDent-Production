...
| [`PLAN_LANDING_REDESIGN.md`](PLAN_LANDING_REDESIGN.md)       | Landing-page redesign plan (6 passes + Pass 1.5). Direction B + selective C accents. Passes 1–6 code-complete 2026-05-02; awaiting owner visual review. |
