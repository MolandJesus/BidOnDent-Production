...
| Doc                                             | Tier | Purpose                                                                                                                                                                                                                              | Notes                                                                                                                                                                                                                                                         |
| ----------------------------------------------- | ---- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `PLAN_PHASE_6_SCOPE.md`                         | PLAN | Scope contract for Phase 6: product intent, in/out-of-scope surfaces, cluster breakdown, risks pulled from Phase 5 diagnose, owner decision points, success criteria, rollback plan. Mirrors `PLAN_PHASE_4_MOBILE_SWEEP.md` pattern. | **SHIPPED 2026-05-04 — PRE-EXECUTION + INVALIDATED BY AUDIT.** Original scope assumed substantial visual lift work; pre-execution audit found prior sweeps (Pass C / Pass H / KI-091) already shipped most of it. Awaiting owner re-scope per audit findings. |
| `OPS_PHASE_6_PRE_EXECUTION_AUDIT_2026-05-04.md` | OPS  | Read-only audit of Clusters 6B / 6C / 6D / 6E surfaces after Cluster 6A halt revealed scope-contract premise was wrong. Verifies canon compliance, KI-108 inventory, Pass C / prior sweep coverage, revised commit estimates.        | **SHIPPED 2026-05-04.** Phase 6 revised total: 1–2 commits (was 8–11). 3 of 5 clusters had 0 findings. Cluster 6E has 1 conditional finding (DashboardCoveragePanel light-mode text-color gating, defensive). Owner reads + chooses execution path A/B/C.     |
| `OPS_LANDING_DASHBOARD_MAP_REDESIGN_LOG.md`     | OPS  | Per-commit execution log for the landing+dashboard map redesign sub-phases. One entry per shipped commit with file-touched list and visual-verification note.                                                                        | Cross-refs MOLANDJESUS for any design choice. **NOT YET WRITTEN** — generated during Phase 6 close per the scope contract (now conditional on revised path A/B/C).                                                                                            |
