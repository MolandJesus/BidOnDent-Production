...
| Doc                                        | Tier | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Notes                                                                                                                                                                                                                                                                                                                                                                                                 |
| ------------------------------------------ | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OPS_PHASE_8_SCOPE_CONTRACT_2026-05-05.md` | OPS  | Execution-authority scope contract for Phase 8: 4 new L3 hooks (`useGeoCoordinates`, `useHaversineDistance`, `useNavigationVoicePriming`, `useShopMapListings`) + relocate `useReportLayerData` to `hooks/` + KI-109 split (`useOperatingRegionsCoverage` 512 LOC → ~360 + ~150 sub-hook). Includes hook signatures (TypeScript), per-hook LOC estimates, caller ordering low-risk first, risk surface map, per-commit verification gate, sub-extraction policy. | **SHIPPED 2026-05-05.** Replaces the originally-conditional `PLAN_MAP_L3_L4_BOUNDARY.md` (deferred since Phase 5 diagnose) with OPS-tier execution contract. ~9 commits estimated (vs framing-brief ~14; consolidated by simpler-hook author+migrate single-commits). No hook hits ≥400 LOC sub-extraction threshold. Awaiting owner scope-contract review before execution relay fires for Commit 1. |
| `OPS_MAP_L3_L4_EXECUTION_LOG.md`           | OPS  | Per-commit execution log for the high-risk L3/L4 boundary work. Each commit references which `OPS_PHASE_8_SCOPE_CONTRACT` subsection it implements + verification evidence.                                                                                                                                                                                                                                                                                      | Per-commit owner gate. Skill notes: `supabase-clerk-edge-function`, `supabase-storage-signed-urls` if relevant. **NOT YET WRITTEN** — fires once owner authorizes execution per the scope contract.                                                                                                                                                                                                   |
