...
| Doc                                               | Tier | Purpose                                                                                                                                                                                                                                                                                                                                                               | Notes                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------- | ---- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `OPS_PHASE_7_5_PRE_EXECUTION_AUDIT_2026-05-04.md` | OPS  | Read-only audit of Phase 7.5 surfaces (dashboard atmosphere, dropdowns, sidebar, mobile bottom nav, card-stack reveal, drag/swipe sheets) against amended `LAW_ANIMATION_AND_ATMOSPHERE.md` §5 (motion/react envelope). Mirrors Phases 6 + 6.5 + 7 audit pattern. Includes added scope item: reduced-motion compliance verification across all 49 motion/react files. | **SHIPPED 2026-05-04.** Findings: 1 P3 (reduced-motion contract honored on 1/49 files; 48 non-compliant), 2 P7-TECHDEBT (mini-map idle drift NOT shipped; dropdown entrance/exit NOT shipped). 0 P0/P1/P2. Card-stack reveal + sheet enter/exit + sidebar timing all canon-compliant via §5 envelope. Phase 7.5 awaiting owner adjudication on F1 mitigation class per audit §2.4 + §8. |
| `OPS_DASHBOARD_ATMOSPHERE_LOG.md`                 | OPS  | Per-commit execution log for dropdown entrance/exit animations, mini-map idle drift, Smart Map Tools hover, card-stack reveal, sidebar timing.                                                                                                                                                                                                                        | **CONDITIONAL** — written only if owner picks Path A and the F1 reduced-motion mitigation produces fix commits, OR if owner authorizes aesthetic additions for F2/F3. Otherwise NOT WRITTEN; the audit doc + parked KIs are the durable record (same outcome as Phases 6 / 6.5 / 7 close-only paths).                                                                                   |
