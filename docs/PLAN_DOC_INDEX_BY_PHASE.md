...
| Doc                               | Tier | Purpose                                                                                                                                                                                                                      | Notes                                         |
| --------------------------------- | ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- |
| `LAW_ANIMATION_AND_ATMOSPHERE.md` | LAW  | Permitted motion vocabulary, performance budget, `prefers-reduced-motion` contract, section-transition pattern, atmosphere-folder rules. CSS-first; framer-motion deferred to explicit Phase 4.6 if 6.5/7.5 hits a CSS wall. | Cross-refs MOLANDJESUS for motion vibe canon. |
