...
- **Pattern reference (for future surfaces):** dark register triad: `0 0 60-80px @ 0.18-0.20` (close), `0 0 100-110px @ 0.10` (mid), `0 0 150-180px @ 0.07-0.12` (far ambient). Light register triad: `0 0 18-44px @ 0.10-0.22` (close), `0 0 60-80px @ 0.05-0.10` (mid), `0 0 140-160px @ 0.04-0.07` (far ambient). Tone: bronze `rgba(196,130,45)` for cool-dominant; amber `rgba(196,144,65)` for ceiling-lamp register; warm-amber `rgba(240,150,60)` for landing warm.
