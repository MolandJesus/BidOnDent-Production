...
The original 1,444-line `PLAN_PRODUCT_BRAIN.md` mixed three tiers of content (LAW-adjacent invariants, current REF state, future PLAN cards) in one file, which misled agents reading it as a single source of truth. Per the doc-tier model in [`LAW_PROJECT_RULES.md`](LAW_PROJECT_RULES.md) and the four-layer model in [`LAW_LAYERED_ARCHITECTURE.md`](LAW_LAYERED_ARCHITECTURE.md), the doc has been **archived in full** (link below) and replaced with this stub plus an extracted [`PLAN_PRODUCT_FUTURE_CARDS.md`](PLAN_PRODUCT_FUTURE_CARDS.md).

> **Note on the table below.** The "Canonical home" column identifies **where new canon on each topic should be added** going forward. The original 1,444 lines were **NOT copied into these destinations** — they remain in the archived original. If you need historical context for a topic, read the archive directly. If you want to ADD canon on a topic, add it to the destination doc named below.

| Topic from the original doc                                          | Canonical home for new work on this topic                                                                                                                                                                                                                                                                                                                              |
| -------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Quick Reference — System Upgrade CARDS (forward-looking work cards)  | [`PLAN_PRODUCT_FUTURE_CARDS.md`](PLAN_PRODUCT_FUTURE_CARDS.md) (extracted in Phase 1.5c)                                                                                                                                                                                                                                                                               |
...
| Visual Language sections                                             | [`MOLANDJESUS_DESIGN_DECISIONS.md`](MOLANDJESUS_DESIGN_DECISIONS.md) (apex, locked) and [`REF_VISUAL_SYSTEM.md`](REF_VISUAL_SYSTEM.md) (implementation snapshot)                                                                                                                                                                                                       |
| Public Landing Page Map / Dashboard Shell Map / Profile Dropdown     | [`MOLANDJESUS_DESIGN_DECISIONS.md`](MOLANDJESUS_DESIGN_DECISIONS.md) (apex, locked) for canon; [`REF_VISUAL_SYSTEM.md`](REF_VISUAL_SYSTEM.md) for implementation snapshot; dashboard premium-lift shipped (Pass D4 final v2) — historical record at [`archive/PLAN_DASHBOARD_REDESIGN_archived_2026-05-05.md`](archive/PLAN_DASHBOARD_REDESIGN_archived_2026-05-05.md) |
