...
| Public Landing Page Map / Dashboard Shell Map / Profile Dropdown     | [`MOLANDJESUS_DESIGN_DECISIONS.md`](MOLANDJESUS_DESIGN_DECISIONS.md) (apex, locked) for canon, [`REF_VISUAL_SYSTEM.md`](REF_VISUAL_SYSTEM.md) and [`PLAN_DASHBOARD_REDESIGN.md`](PLAN_DASHBOARD_REDESIGN.md) for implementation/PLAN |
