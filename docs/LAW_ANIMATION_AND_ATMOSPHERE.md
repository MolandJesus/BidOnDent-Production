...
| `orbDrift`       | Ambient orb horizontal drift             | Landing background atmosphere; dashboard `.bd-dashboard-atmosphere` living gold-lava layers (28s + 36s, crossing-phase, in `theme.css`) |
