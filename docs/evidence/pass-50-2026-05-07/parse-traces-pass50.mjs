// Pass 50 — Trace parser. Same shape as pass-48-parse-traces.mjs but
// reads from pass-50-2026-05-07/ and emits parsed-summary-pass50.{json,md}.
...
fs.writeFileSync(path.join(BASE, "parsed-summary-pass50.json"), JSON.stringify(all, null, 2));

const lines = ["# Pass 50 — useParallaxOffset Throttle: Parsed Trace Summary", ""];
...
fs.writeFileSync(path.join(BASE, "parsed-summary-pass50.md"), lines.join("\n"));
console.log("\nWrote parsed-summary-pass50.{json,md}");
