...
//
// Outputs:
//   docs/evidence/pass-50-2026-05-07/trace-landing-{1280,375}-after-noscroll-pass50.json
//   docs/evidence/pass-50-2026-05-07/trace-landing-{1280,375}-after-scrolled-pass50.json
//   docs/evidence/pass-50-2026-05-07/runtime-summary-after.json
...
const BASE = path.resolve("docs/evidence/pass-50-2026-05-07");
const URL = process.env.PASS50_URL ?? "http://localhost:5173/";
...
async function runViewport(browser, viewport) {
  ...
  // Scenario A: noscroll
  {
    ...
    await sleep(1200);
    const file = `trace-landing-${viewport.id}-after-noscroll-pass50.json`;
  ...
  // Scenario B: scrolled
  {
    ...
    const file = `trace-landing-${viewport.id}-after-scrolled-pass50.json`;
    const tp = await startTrace(page, file);
