...
class DemoDataService {
  ...
  async getDamageReports(userId: string, userType: 'customer' | 'shop' | 'insurer'): Promise<DamageReport[]> {
  ...
  async updateDamageReport(id: string, updates: Partial<DamageReport>): Promise<DamageReport | null> {
    const reports = this.getAllReports();
