      ...
      <div className="max-w-3xl mx-auto bd-glass-card p-8 md:p-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Last updated: March 24, 2026</p>
          </div>
        </div>
        ...
        <ul className="list-disc pl-5 space-y-2 text-slate-700 leading-relaxed mb-5">
        ...
        <h2 className="text-xl font-semibold text-slate-900 mb-3">4. User Roles</h2>
        <div className="space-y-3 mb-5">
          <div className="bd-glass-card rounded-xl p-4">
            <h3 className="font-medium text-slate-900 mb-1">Customers</h3>
          ...
          <div className="bd-glass-card rounded-xl p-4">
            <h3 className="font-medium text-slate-900 mb-1">Body Shops</h3>
            <p className="text-sm text-slate-600">
          ...
          <div className="bd-glass-card rounded-xl p-4">
            <h3 className="font-medium text-slate-900 mb-1">Insurers</h3>
            <p className="text-sm text-slate-600">
        ...
        <h2 className="text-xl font-semibold text-slate-900 mb-3">5. Bids and Transactions</h2>
        <ul className="list-disc pl-5 space-y-2 text-slate-700 leading-relaxed mb-5">
        ...
        <h2 className="text-xl font-semibold text-slate-900 mb-3">7. Content and Data</h2>
        <p className="text-slate-700 leading-relaxed mb-5">
