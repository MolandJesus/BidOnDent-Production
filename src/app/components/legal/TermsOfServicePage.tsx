    ...
    <main
      className={`min-h-screen py-14 px-4 ${
        isLight
          ...
          : "dark bg-gradient-to-b from-[#08142b] via-[#0a1626] to-[#060d1c]"
      }`}
    >
      <div className="max-w-3xl mx-auto bd-glass-card p-8 md:p-10">
        ...
        <ul
          className={`list-disc pl-5 space-y-2 leading-relaxed mb-5 ${isLight ? "text-slate-700" : "text-slate-300"}`}
        >
        ...
        <div className="space-y-3 mb-5">
          <div className="bd-glass-card rounded-xl p-4">
            <h3 className={`font-medium mb-1 ${isLight ? "text-slate-900" : "text-slate-100"}`}>
              Customers
            </h3>
            <p className={`text-sm ${isLight ? "text-slate-500" : "text-slate-400"}`}>
