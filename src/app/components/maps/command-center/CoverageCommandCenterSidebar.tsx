...
export default function CoverageCommandCenterSidebar({
  ...
  return (
    <aside className="border-t border-white/10 p-3.5 sm:p-6 xl:border-t-0 xl:border-l">
      <div className="max-h-[66vh] space-y-4 overflow-y-auto pr-1 sm:max-h-[70vh]">
        <div className="grid gap-3 sm:grid-cols-3 xl:grid-cols-1">
          <div className={cn("map-liquid-card map-ui-enter p-4", theme.panelClassName)}>
