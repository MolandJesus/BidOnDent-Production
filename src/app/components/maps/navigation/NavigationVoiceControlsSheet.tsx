...
export default function NavigationVoiceControlsSheet({
  ...
  return (
    <div className="pointer-events-none absolute inset-x-4 bottom-6 z-[565] flex justify-end">
      <div className={cn("pointer-events-auto w-full max-w-[440px] p-5", theme.panelStrongClassName)}>
        <div className="flex items-start justify-between gap-3">
          <div>
            <div className={cn("text-3xl font-semibold tracking-[-0.04em]", theme.titleClassName)}>
              Voice Controls
            </div>
        ...
        <div className={cn("mt-5 p-2", theme.panelClassName)}>
        ...
        <div className="mt-5">
          ...
          <div className={cn("mt-3 space-y-2 p-3", theme.panelClassName)}>
