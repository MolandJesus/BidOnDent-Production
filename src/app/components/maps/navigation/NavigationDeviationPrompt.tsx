...
export default function NavigationDeviationPrompt({
  ...
  return (
    <div
      className={`animate-in fade-in slide-in-from-top-2 mx-auto flex max-w-2xl items-center gap-4 rounded-2xl border px-5 py-3.5 backdrop-blur-xl duration-300 motion-reduce:animate-none ${
        isDark
