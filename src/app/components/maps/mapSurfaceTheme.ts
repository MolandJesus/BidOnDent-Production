...
const toneThemes: Record<MapSurfaceTone, Omit<MapSurfaceTheme, keyof typeof baseTheme>> = {
  light: {
    ...
    panelStrongToneClassName:
      "border-blue-100/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.86),rgba(219,234,254,0.74))]",
    accentPanelToneClassName:
      "border-blue-300/80 bg-[linear-gradient(180deg,rgba(239,246,255,0.94),rgba(191,219,254,0.8))]",
    segmentedToneClassName: "border-white/80 bg-white/72",
    activeSegmentClassName:
      "bg-[linear-gradient(180deg,#2563eb,#1d4ed8)] text-white shadow-[0_12px_22px_rgba(37,99,235,0.28)]",
    inactiveSegmentClassName: "text-slate-600 hover:bg-white/80 hover:text-slate-900",
    primaryButtonToneClassName:
      "border-blue-300/80 bg-[linear-gradient(180deg,#3b82f6,#1d4ed8)] text-white shadow-[0_14px_26px_rgba(37,99,235,0.26)] hover:-translate-y-0.5 hover:shadow-[0_18px_30px_rgba(37,99,235,0.3)]",
    ...
    selectedListCardToneClassName:
      "border-blue-300/80 bg-[linear-gradient(180deg,rgba(239,246,255,0.96),rgba(191,219,254,0.86))] shadow-[0_22px_44px_rgba(37,99,235,0.18)]",
  },
  dark: {
    ambientOverlayClassName:
