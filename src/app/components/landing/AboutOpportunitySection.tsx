    ...
    >
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <h3 className="text-3xl sm:text-4xl font-bold mt-5 mb-4 text-slate-900">
            Opportunity Through Transparency
          </h3>
          <p className="text-base sm:text-xl leading-relaxed text-slate-700 max-w-3xl mx-auto">
          ...
          {cards.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <p className="text-sm text-slate-600 leading-relaxed border-t border-blue-100/60 pt-4">
                    {item.expandedText}
                  </p>
                </div>
