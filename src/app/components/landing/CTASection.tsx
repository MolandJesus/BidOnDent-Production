...
export default function CTASection({ primaryColor, onNavigateToDashboard }: CTASectionProps) {
  ...
  return (
    <section
      className="py-16 md:py-24 lg:py-32 bg-gradient-to-b from-[#eef4ff] via-[#f0f6ff] to-[#fafbff] relative overflow-hidden"
      ref={sectionRef}
    >
      <div className="container mx-auto px-4 max-w-6xl text-center relative">
        ...
        >
          <div className="absolute -top-6 -left-4 md:-left-8 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-2xl bg-gradient-to-br from-amber-300 to-orange-400 rotate-12 opacity-90" style={{ boxShadow: "0 8px 24px rgba(245, 158, 11, 0.25), 0 0 40px rgba(245, 158, 11, 0.10)" }} />
          <div
            ...
            style={{ boxShadow: "0 8px 24px rgba(59, 130, 246, 0.30), 0 0 48px rgba(14, 165, 233, 0.15)", animationDelay: "1.2s" }}
          />
            ...
            {isSignedIn ? (
              <button
                ...
                style={{
                  ...
                  boxShadow: "0 4px 20px rgba(37, 99, 235, 0.30), 0 0 32px rgba(59, 130, 246, 0.12)",
                }}
              >
                Go to Dashboard
