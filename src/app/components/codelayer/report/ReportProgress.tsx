...
export default function ReportProgress({
  ...
  return (
    <div
      className={`bd-glass-panel${isLightAppearance ? " bd-light-surface" : ""} !rounded-none px-2.5 sm:px-4 md:px-6 py-2.5 sm:py-3 ${
              ...
              <div
                className={`w-8 h-8 rounded-full text-sm font-semibold flex items-center justify-center transition-all ${
                  step <= activeStep
                    ? "text-white"
                    : isLightAppearance
                      ? "bg-blue-100/60 border border-blue-300/40 text-blue-700"
