    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bd-glass-floating p-5 sm:p-6 rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          ...
          <button className="text-slate-400 hover:text-slate-300" onClick={onClose}>
            <X className="w-5 h-5" />
          </button>
        </div>
        <div className="space-y-4">
          <div className="border rounded-lg p-4 bg-white/[0.04]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Expires 08/26</p>
                </div>
              </div>
              <button className="text-sm text-blue-600 hover:underline">Remove</button>
            </div>
          ...
          <button
            className="bd-glass-control--utility w-full py-3 border-2 border-dashed border-white/[0.10]/60 rounded-lg"
