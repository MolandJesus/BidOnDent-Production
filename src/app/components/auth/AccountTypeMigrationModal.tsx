...
export default function AccountTypeMigrationModal({
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: 'linear-gradient(135deg, rgba(0, 61, 130, 0.95) 0%, rgba(0, 93, 166, 0.95) 100%)',
      }}
    >
      <motion.div 
      ...
      >
        ...
        <div className="space-y-3 mb-6">
          ...
          <motion.button
            ...
            className="w-full py-4 px-4 border-2 rounded-lg font-medium hover:bg-gray-50 transition-all text-left flex items-center gap-3"
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-gray-600">
                I need auto body repairs for my vehicle
              </div>
            </div>
          </motion.button>
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
          <p className="text-xs text-yellow-800">
            <strong>Note:</strong> This selection is permanent and cannot be changed later. 
            Choose the option that matches how you originally created this account.
          </p>
        </div>
      </motion.div>
    </div>
