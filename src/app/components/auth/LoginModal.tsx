        ...
        {loginView === "main" && (
          <div className="space-y-4">
            ...
            <motion.button
              ...
              className="w-full py-3 px-4 border-2 rounded-lg font-medium hover:bg-gray-50 transition-colors text-left flex items-center justify-between"
