      ...
      <div className="bg-white rounded-xl shadow-xl p-5 sm:p-8 max-w-2xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <button
            ...
            className={`p-6 rounded-lg transition-all ${
              selectedType === "customer"
                ? "bd-glass-card border-2 border-blue-500/60 bg-blue-50/60"
          ...
          >
            ...
            <p className="text-sm text-gray-600">Get repair quotes for your vehicle</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-600">Bid on repair jobs</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-gray-600">Manage claims and shops</p>
          </button>
        </div>
